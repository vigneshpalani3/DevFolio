...
const Projects = () => {
  return (
    <section id="Projects" className='min-h-screen pt-10 py-10 mx-8'>
      <h1 className='text-3xl font-sora font-bold
      text-transparent flex items-center gap-1 tracking-wide bg-gradient-to-br from-blue-950 via-blue-800 to-blue-500 w-fit bg-clip-text'>Projects</h1>
      <div className=" flex flex-col gap-12 sm:gap-20 mt-8 sm:mt-16">
